...
const SpecialMenu = () => {
  ...
  return (
    <div className={`${styles["app__specialMenu"]} flex__center section__padding`}>
      ...
      <div className={`${styles["app__specialMenu-menu"]}`}>
        <div className={`${styles["app__specialMenu-menu_wine"]} flex__center`}>
          <p className={`${styles["app__specialMenu-menu_heading"]}`}>Wine & Beer</p>
        ...
        <div className={`${styles["app__specialMenu-menu_cocktails"]} flex__center`}>
          <p className={`${styles["app__specialMenu-menu_heading"]}`}>Cocktails</p>
          <div className={`${styles["app__specialMenu-menu_items"]}`}>
